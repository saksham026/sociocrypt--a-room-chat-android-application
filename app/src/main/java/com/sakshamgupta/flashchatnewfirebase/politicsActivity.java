...
public class politicsActivity extends AppCompatActivity {
    ...
    private politicsChatListAdapter mAdapter;
            ...
            ref.putFile(filePath)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            progressDialog.dismiss();
                            Toast.makeText(politicsActivity.this, "Uploaded", Toast.LENGTH_SHORT).show();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            progressDialog.dismiss();
                            Toast.makeText(politicsActivity.this, "Failed "+e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
    ...
    private void sendMessage() {
        ...
        if (!input.equals("")) {
            ...
            mDatabaseReference.child("politics").push().setValue(chat);
            mInputText.setText("");
        }
    ...
    public void onStart() {
        super.onStart();
        mAdapter = new politicsChatListAdapter(this, mDatabaseReference, mDisplayName);
